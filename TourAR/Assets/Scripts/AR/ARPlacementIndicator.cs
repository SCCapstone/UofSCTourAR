...
public class ARPlacementIndicator : MonoBehaviour
{
    ...
    [SerializeField] GameObject transparentBox;
    ...
    public GameObject movePhone, doubleTapPhone; //animated icons in UI
    ...
    void Update ()
    {
      if (!objectPlaced) { //only raycasts before object has been placed
        ...
        if(placementPoseIsValid)
        {
            ...
            transparentBox.transform.SetPositionAndRotation(placementPose.position, placementPose.rotation);
